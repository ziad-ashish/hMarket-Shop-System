...
ENDPOINT_PERMISSIONS = {
    ...
    # Sales staff can create the lightweight customer record used by POS.
    # The API itself only relaxes the phone requirement when quick_pos is set.
    "add_customer": ("customers", "sales"),
    ...
    "get_sale_payment_proof": ("invoices", "invoices_view", "sales"),
    "void_sale": ("invoices",),
